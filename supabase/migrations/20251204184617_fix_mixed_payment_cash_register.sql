/*
  # Corrigir registro de pagamento misto no caixa

  ## Problema
  - Função link_sale_to_cash_register verifica 'money' mas o método é 'dinheiro'
  - Pagamentos mistos com dinheiro não estão sendo registrados no caixa

  ## Solução
  - Atualizar função para verificar 'dinheiro' em vez de 'money'
*/
