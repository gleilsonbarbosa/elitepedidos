...
const OrderTrackingPage: React.FC = () => {
  ...
  const getPaymentMethodLabel = (method: string) => {
    switch (method) {
      ...
      case 'pix_entregador': return 'PIX Entregador (Pagar na entrega)';
      case 'pix_online': return 'PIX Online (85989041010)';
      case 'pix': return 'PIX (85989041010)'; // Manter compatibilidade
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          {/* Estimated Delivery */}
          {order.delivery_type === 'pickup' && order.scheduled_pickup_date && order.scheduled_pickup_time && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center gap-2">
                <Store size={20} className="text-green-600" />
                <div>
                  <p className="font-medium text-green-800">Agendamento de Retirada</p>
                  <p className="text-green-700">
                    {new Date(order.scheduled_pickup_date).toLocaleDateString('pt-BR')} às {order.scheduled_pickup_time}
                  </p>
          ...
          {order.delivery_type === 'delivery' && order.estimated_delivery && order.status !== 'delivered' && order.status !== 'cancelled' && (
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {order.delivery_type === 'pickup' ? (
                    <>
                      <p className="text-gray-600">Rua Um, 1614-C – Residencial 1 – Cágado</p>
