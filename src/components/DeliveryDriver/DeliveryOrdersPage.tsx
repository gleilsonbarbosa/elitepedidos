...
const DeliveryOrdersPage: React.FC = () => {
  ...
  const handleWhatsApp = (order: DeliveryOrder) => {
    ...
    if (order.delivery_type === 'pickup') {
      ...
      message += `Rua Um, 1614-C – Residencial 1 – Cágado\n`;
    ...
    message += `Amanda Suyelen da Costa Pereira - Elite Açaí - ${order.delivery_type === 'pickup' ? 'Retirada agendada' : 'Entrega confirmada'}! 🍧`;
